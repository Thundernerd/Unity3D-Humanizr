        ...
        private string UnitByGender(long number, GrammaticalGender? gender)
        {
            ...
            switch (gender)
            {
                case GrammaticalGender.Masculine:
                    return UnitsMasculineOverrideMap[number - 1];
                case GrammaticalGender.Feminine:
                    return UnitsFeminineOverrideMap[number - 1];
                case GrammaticalGender.Neuter:
                    return UnitsNeuterOverride[number - 1];
                case null:
                    return UnitsIntraOverride[number - 1];
                default:
